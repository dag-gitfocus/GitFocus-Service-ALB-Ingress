 ...
 */
@Service
public class CommitDetailServiceImpl implements ICommitDetailService {
    ...
    private final static Logger logger = LoggerFactory.getLogger(CommitDetailServiceImpl.class);
